            ...
            <div className="footer-container">
                <div className="footer-grid">
                    <div className="footer-section">
                        <h3 className="footer-title">DONIDG STORE</h3>
                        <p className="footer-text">
                            <i className="fa-solid fa-shop"></i> Chuyên cung cấp
                            giày sneaker chính hãng, uy tín – chất lượng. Cam
                    ...
                    <div className="footer-section">
                        ...
                        <p>
                            ...
                            min@donidgstudio.com
                        </p>
                    </div>

                    <div className="footer-section">
                        <h3 className="footer-title">THƯƠNG HIỆU</h3>
                        <Link href="/nike" className="footer-link">
                            Nike
                        </Link>
                    ...
                    <div className="footer-section">
                        ...
                        <Link href="/bao-quan-giay" className="footer-link">
                            Cách bảo quản giày
                        </Link>
                        <Link href="/ngay-hot-deal" className="footer-link">
                            Ngày hot deal
                        </Link>
                    </div>
                </div>
